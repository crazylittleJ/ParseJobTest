...
var basicAuth = express.basicAuth('Test','1234');

// The information showed about the poster
var userEmail = 'haha@gmail.com';
var userDisplayName = 'Current time';
var userDescription = 'All posts will be auto-deleted every 5 mins';
...
app.locals.timetime = moment().format('MMMM Do YYYY, h:mm:ss a');
